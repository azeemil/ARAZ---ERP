...

{
    internal class Variables
    {
        ...
        public static string ConnectionString = @"Data Source='172.16.10.20';Application Name='ARAZ ERP';Initial Catalog='ARAZERP';User ID='terminal';Password='texnologiya252'";
        public static string TigerConnection = @"Data Source='172.16.10.20';Application Name='ARAZ ERP';Initial Catalog='ARAZ';User ID='terminal';Password='texnologiya252'";
