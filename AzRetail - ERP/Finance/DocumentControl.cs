...
namespace ERP.Finance
{
    public partial class DocumentControl :  XtraForm
    {
        ...
        private void searchBtn_Click(object sender, EventArgs e)
        {
            ...
            docTypeTxt.Text = _dt.Rows[0][0].ToString();
            invoiceNoTxt.Text = _dt.Rows[0][1].ToString();
            docNoTxt.Text = _dt.Rows[0][2].ToString();
            whouse1Txt.Text = _dt.Rows[0][3].ToString();
            whouse2Txt.Text = _dt.Rows[0][4].ToString();
        ...
        {
            barkodTxt.Text = invoiceNoTxt.Text = docTypeTxt.Text = docNoTxt.Text = whouse1Txt.Text = whouse2Txt.Text = string.Empty;
