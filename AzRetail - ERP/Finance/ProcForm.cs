...
namespace ERP.Finance
{
    public partial class ProcForm : XtraForm
    {
        ...
        private void simpleButton1_Click(object sender, EventArgs e)
        {
            ...
            if (!app.LoggedIn)
                if (!app.Login(Variables.TigerUserName, Variables.TigerUserPassword, int.Parse(Variables.FirmNr), int.Parse(Variables.FirmPeriod)))
                {
        ...
        public void PostKassa(string clKode,string clName,float total,int trcode, bool tradingGrp)
        {
            ...
            sdTransaction.DataFields.FieldByName("DESCRIPTION").Value = descr + ":"+ General.User.UserId+"_" + General.User.UserName;
            ...
            //sdTransaction.DataFields.FieldByName("NOTES2").Value = General.User.UserName;
            //sdTransaction.DataFields.FieldByName("NOTES3").Value = General.User.UserId;
        ...
        public void PostCredit(string bankCode,string total,string clcard)
        {
            ...
            arpVoucher.DataFields.FieldByName("NOTES2").Value = General.User.UserName;
            arpVoucher.DataFields.FieldByName("NOTES3").Value = General.User.UserId;
