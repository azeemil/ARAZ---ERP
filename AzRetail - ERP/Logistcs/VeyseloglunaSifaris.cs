    ...
    public partial class VeyseloglunaSifaris : XtraForm
    {
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            var master = new ClsOrderMaster
            {
                ...
                DOC_TRACK_NR = "OBA"+ DateTime.Today.ToString("ddMMhhmm"),
                DIVISION = "0",
            ...
            var result = _soapService.LogoOrderWithResult(_userNameBase64, _passwordBase64, _imeiBase64, 2, "", master,lines);
